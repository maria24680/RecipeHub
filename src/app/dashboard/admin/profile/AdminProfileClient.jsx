...
export default function AdminProfileClient({ user: initialUser }) {
    ...
    return (
        <div className="p-6 pt-8 max-w-3xl mx-auto space-y-6">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Manage your administrator account</p>
            </motion.div>
                ...
                <form onSubmit={handleUpdate} className="p-6 space-y-6">
                    ...
                    <div className="flex flex-col items-center gap-4 pb-6 border-b border-gray-100 dark:border-gray-800">
                        ...
                        <div className="text-center">
                            ...
                            <span className="inline-block mt-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-gradient-to-r from-zinc-700 to-zinc-900 text-white">
                                Admin
                            </span>
                            {user?.isPremium && (
